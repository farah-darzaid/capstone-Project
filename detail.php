<?php include('includes/public_header.php'); ?>
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <a href="images/clean house 1.png" class="grid image-link">
                        <img src="images/clean house 1.png" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="images/dearborn-painting-professional.jpg" class="grid image-link">
                        <img src="images/dearborn-painting-professional.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="images/English-Teacher-Cover-Letter-Banner.jpg" class="grid image-link">
                        <img src="images/English-Teacher-Cover-Letter-Banner.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="images/electrician-1154x768.jpg" class="grid image-link">
                        <img src="images/electrician-1154x768.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="images/residentialcleaningservice.jpg" class="grid image-link">
                        <img src="images/residentialcleaningservice.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="images/pasted image 0.png" class="grid image-link">
                        <img src="images/pasted image 0.png" class="img-fluid" alt="#">
                    </a>
                </div>
            </div>
            <!-- Add Pagination -->
    ...
    <section class="reserve-block">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>The simplest way to find your services</h5>
                    <p><span>$$$</span>$$</p>
            ...
            <div class="row">
                    ...
                    <div class="booking-checkbox_wrap mt-4">
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <ul>
                                    <li><img src="images/electrician-1154x768.jpg" class="img-fluid" alt="#"></li>
                                    <li><img src="images/English-Teacher-Cover-Letter-Banner.jpg" class="img-fluid" alt="#"></li>
                                    <li><img src="images/residentialcleaningservice.jpg" class="img-fluid" alt="#"></li>
                                </ul>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13538.299497101198!2d35.8325012!3d31.9724281!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xe04bf74531579108!2sAlHussein%20Technical%20University!5e0!3m2!1sen!2sjo!4v1578495284188!5m2!1sen!2sjo" width="100%" height="350" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> Bulding 23, King Hussein Business Park, شارع الملك عبدالله الثاني 242, Amman</p>
                        </div>
                        <div class="address">
